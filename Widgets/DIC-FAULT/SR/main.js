...
"use strict";
module.exports = /*#__PURE__*/JSON.parse('{"id":"58cc7b7d-011f-40a8-f342-5e3b1ae0b8f7","author":"Taraka","widgets":[{"id":"defectsummary-prioritywise-demo","name":"Defect Summary PriorityWise Demo","description":"Defect Summary PriorityWise (Demo version)","icon":"","tags":[],"category":"","isTemplate":false}],"sidebarLinks":[],"uis":[],"menuItems":[]}');
...
/***/ "./src/demo/DefectSummaryPriorityWisedemo.tsx":
/*!****************************************************!*\
  !*** ./src/demo/DefectSummaryPriorityWisedemo.tsx ***!
  \****************************************************/
...
const SLAStackchartdemo_1 = __importDefault(__webpack_require__(/*! ./SLAStackchartdemo */ "./src/demo/SLAStackchartdemo.tsx"));
(0, highcharts_more_1.default)(highcharts_1.default);
const colors = ["#62f06c", "#71a8f5", "#fab361", "#abf768", "#c061ff", "#ff6e6e", "#bab1b1", "#bd92de"];
const DefectSummary = (props) => {
    ...
    const [GroupWiseData, setGroupWiseData] = React.useState([]);
    ...
    function GetLocations() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            axios_1.default.get(`${execurl}?apikey=${API_KEY}`)
                ...
                // props.uxpContext?.executeAction("C2ODashboard", 'GetBuildings', {}, { json: true })
                // .then(res => {
                //     setLocationList(res.Locations);
                //     if(res.Selected != null && res.Selected != ''){
                //         if(res.Locations.length>0){
                //             let loclist : any[]= res.Locations;
                //             var __FOUNDLoc =loclist.find(function(post, index) {
                //                 if(post.LocationKey == res.Selected.toString()){
                //                     return post.LocationKey;
                //                 }
                //             });
                //             setTimeOffset(__FOUNDLoc.TimeOffset);
                //             setLocationKey(res.Selected);
                //         }
                //     }
                //     else{
                //         setTimeOffset(res.Locations.length>0 ? res.Locations[0].TimeOffset : null);
                //         setLocationKey(res.Locations.length>0 ? res.Locations[0].LocationKey : null);
                //     }
            })
                .catch(e => {
    ...
    React.useEffect(() => {
        setSelectedYear(YearList.length > 0 ? YearList[0].value : null);
    }, [YearList]);
    React.useEffect(() => {
        setCHLength(document.getElementById('defectbarchartprio-container').clientWidth);
        setCHHeight(document.getElementById('defectbarchartprio-container').clientHeight);
        GetDatafromDB();
    }, [Locationkey, selectedYear]);
    ...
    function GroupPriorityWise(DfctData) {
        return __awaiter(this, void 0, void 0, function* () {
            var datagroup = yield DfctData.reduce(function (r, a) {
                r[a.PriorityKey] = r[a.PriorityKey] || [];
                r[a.PriorityKey].push(a);
                return r;
            }, Object.create(null));
            var arraydesign = yield Object.values(datagroup);
            return arraydesign;
        });
    }
    React.useEffect(() => {
    ...
    function Designseries() {
        return __awaiter(this, void 0, void 0, function* () {
            let chdata = [];
            for (var l = 0; l < GroupWiseData.length; l++) {
                chdata.push({
                    name: GroupWiseData[l].length > 0 ? GroupWiseData[l][0].PriorityID : "",
                    data: yield OrganizeData(GroupWiseData[l]),
                    color: colors.length > l ? colors[l] : null
                });
            }
            setChartData(chdata);
        });
    }
    function DBDataProcess(gotdata) {
        return __awaiter(this, void 0, void 0, function* () {
            let grpwdata = yield GroupPriorityWise(gotdata);
            setGroupWiseData(grpwdata);
        });
    }
    let toast = (0, components_1.useToast)();
    function GetDatafromDB() {
        return __awaiter(this, void 0, void 0, function* () {
            if (Locationkey != null && selectedYear != null) {
                // let execurl = '';
                // if(`${window.location.origin}/` === 'https://test.maftestbed.servicedeskhq.com/'){
                //     execurl = 'https://script.google.com/macros/s/AKfycbzSnDxjruu9LpyhEbKaIsy7_0SWRSEE40LjDCBwCaPqET4BkvYYF34qh61HoN-DpTMzsg/exec';
                // }
                // else{
                //     execurl = 'https://script.google.com/macros/s/AKfycbznAXM8RToy-STlAqOzf2KrA7Ha661oIovHKXpGCORahEsXUGEK8z-0YvyWhlFEF055/exec';
                // }
                // try { 
                //     let property =`${execurl}?LocationKey=${Locationkey}&Year=${selectedYear}`;
                //     let gotdailydetails = await fetch(property);
                //     let res = await gotdailydetails.json();
                //     DBDataProcess(res);
                // } catch (error) {
                //     setGroupWiseData([]);
                //     console.log(error);
                // }
                // props.uxpContext?.executeAction("C2ODemoWidgetHelper", 'GetMonthlyPriorityWiseDefectSummary', {Year:selectedYear,Locationkey:Locationkey,TimeOffset:TimeOffset}, { json: true })
                // .then(res => {
                //     DBDataProcess(res);
                // })
                //     .catch(e => {
                ...
                let execurl = `${base_url_content_1.BASE_URL}/api/${appurl}/GetC2ODemoPriorityWiseDefectSummaryAPI`;
                let parm = `&LocationKey=${Locationkey}&Year=${selectedYear}`;
    ...
    function OrganizeData(DArrr) {
        return __awaiter(this, void 0, void 0, function* () {
            var chartobject = [];
            for (var t = 0; t < 12; t++) {
                var __FOUNDMonth = yield DArrr.find(function (post, index) {
                    if (post.Month == (t + 1).toString()) {
                        return post.Month;
                    }
                });
                if (__FOUNDMonth != undefined) {
                    chartobject.push({ x: t, y: parseFloat(__FOUNDMonth.FaultyCount) });
                }
            }
            return (chartobject);
        });
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement("div", { className: `main-container ${isDarkMode ? 'dark-mode' : 'light-mode'}`, style: Object.assign({ height: "500px", marginBottom: "20px", width: "100%", borderRadius: "10px", background: isDarkMode ? 'rgba(20, 20, 20, 0.25)' : 'rgba(255, 255, 255, 0.15)', color: isDarkMode ? '#fff' : '#333', transition: 'all 0.3s ease', boxShadow: '0 8px 32px 0 rgba(31, 38, 135, 0.15)', padding: '16px', boxSizing: 'border-box' }, (isDarkMode ? darkThemeStyles : {})) },
            React.createElement("div", { id: 'defectbarchartprio-container', style: { width: "100%", height: "100%", position: "relative" } },
                React.createElement("div", { style: {
                    ...
                    React.createElement("div", { style: { display: 'flex', alignItems: 'center' } },
                        React.createElement("svg", { width: "20", height: "20", viewBox: "0 0 640 512", style: { marginRight: '10px' }, fill: "none", xmlns: "http://www.w3.org/2000/svg" },
                            React.createElement("path", { d: "M512.1 191l-8.2 14.3c-3 5.3-9.4 7.5-15.1 5.4-11.8-4.4-22.6-10.7-32.1-18.6-4.6-3.8-5.8-10.5-2.8-15.7l8.2-14.3c-6.9-8-12.3-17.3-15.9-27.4h-16.5c-6 0-11.2-4.3-12.2-10.3-2-12-2.1-24.6 0-37.1 1-6 6.2-10.4 12.2-10.4h16.5c3.6-10.1 9-19.4 15.9-27.4l-8.2-14.3c-3-5.2-1.9-11.9 2.8-15.7 9.5-7.9 20.4-14.2 32.1-18.6 5.7-2.1 12.1.1 15.1 5.4l8.2 14.3c10.5-1.9 21.2-1.9 31.7 0L552 6.3c3-5.3 9.4-7.5 15.1-5.4 11.8 4.4 22.6 10.7 32.1 18.6 4.6 3.8 5.8 10.5 2.8 15.7l-8.2 14.3c6.9 8 12.3 17.3 15.9 27.4h16.5c6 0 11.2 4.3 12.2 10.3 2 12 2.1 24.6 0 37.1-1 6-6.2 10.4-12.2 10.4h-16.5c-3.6 10.1-9 19.4-15.9 27.4l8.2 14.3c3 5.2 1.9 11.9-2.8 15.7-9.5 7.9-20.4 14.2-32.1 18.6-5.7 2.1-12.1-.1-15.1-5.4l-8.2-14.3c-10.4 1.9-21.2 1.9-31.7 0zm-10.5-58.8c38.5 29.6 82.4-14.3 52.8-52.8-38.5-29.7-82.4 14.3-52.8 52.8zM386.3 286.1l33.7 16.8c10.1 5.8 14.5 18.1 10.5 29.1-8.9 24.2-26.4 46.4-42.6 65.8-7.4 8.9-20.2 11.1-30.3 5.3l-29.1-16.8c-16 13.7-34.6 24.6-54.9 31.7v33.6c0 11.6-8.3 21.6-19.7 23.6-24.6 4.2-50.4 4.4-75.9 0-11.5-2-20-11.9-20-23.6V418c-20.3-7.2-38.9-18-54.9-31.7L74 403c-10 5.8-22.9 3.6-30.3-5.3-16.2-19.4-33.3-41.6-42.2-65.7-4-10.9.4-23.2 10.5-29.1l33.3-16.8c-3.9-20.9-3.9-42.4 0-63.4L12 205.8c-10.1-5.8-14.6-18.1-10.5-29 8.9-24.2 26-46.4 42.2-65.8 7.4-8.9 20.2-11.1 30.3-5.3l29.1 16.8c16-13.7 34.6-24.6 54.9-31.7V57.1c0-11.5 8.2-21.5 19.6-23.5 24.6-4.2 50.5-4.4 76-.1 11.5 2 20 11.9 20 23.6v33.6c20.3 7.2 38.9 18 54.9 31.7l29.1-16.8c10-5.8 22.9-3.6 30.3 5.3 16.2 19.4 33.2 41.6 42.1 65.8 4 10.9.1 23.2-10 29.1l-33.7 16.8c3.9 21 3.9 42.5 0 63.5zm-117.6 21.1c59.2-77-28.7-164.9-105.7-105.7-59.2 77 28.7 164.9 105.7 105.7zm243.4 182.7l-8.2 14.3c-3 5.3-9.4 7.5-15.1 5.4-11.8-4.4-22.6-10.7-32.1-18.6-4.6-3.8-5.8-10.5-2.8-15.7l8.2-14.3c-6.9-8-12.3-17.3-15.9-27.4h-16.5c-6 0-11.2-4.3-12.2-10.3-2-12-2.1-24.6 0-37.1 1-6 6.2-10.4 12.2-10.4h16.5c3.6-10.1 9-19.4 15.9-27.4l-8.2-14.3c-3-5.2-1.9-11.9 2.8-15.7 9.5-7.9 20.4-14.2 32.1-18.6 5.7-2.1 12.1.1 15.1 5.4l8.2 14.3c10.5-1.9 21.2-1.9 31.7 0l8.2-14.3c3-5.3 9.4-7.5 15.1-5.4 11.8 4.4 22.6 10.7 32.1 18.6 4.6 3.8 5.8 10.5 2.8 15.7l-8.2 14.3c6.9 8 12.3 17.3 15.9 27.4h16.5c6 0 11.2 4.3 12.2 10.3 2 12 2.1 24.6 0 37.1-1 6-6.2 10.4-12.2 10.4h-16.5c-3.6 10.1-9 19.4-15.9 27.4l8.2 14.3c3 5.2 1.9 11.9-2.8 15.7-9.5 7.9-20.4 14.2-32.1 18.6-5.7 2.1-12.1-.1-15.1-5.4l-8.2-14.3c-10.4 1.9-21.2 1.9-31.7 0zM501.6 431c38.5 29.6 82.4-14.3 52.8-52.8-38.5-29.6-82.4 14.3-52.8 52.8z", fill: "#ffffff" })),
                        React.createElement("h3", { style: { margin: '0', fontSize: '16px', fontWeight: '400', color: '#ffffff' } }, "Monthly Fault Summary")),
                    React.createElement("div", { style: { display: 'flex', alignItems: 'center', gap: '5px' } },
                        React.createElement("div", { style: { width: "100px" } },
                            React.createElement(components_1.Select, { className: 'Common-yearfilter', selected: selectedYear, options: YearList, onChange: setSelectedYear, showEndOfContent: false })),
                        React.createElement("div", { style: { width: "150px" } },
                            React.createElement(components_1.Select, { className: 'Common-locationfilter', selected: Locationkey, options: Locationlist, labelField: "LocationID", valueField: "LocationKey", onChange: (newValue, option) => {
                                    setTimeOffset(parseFloat(option.TimeOffset));
                                    setLocationKey(newValue);
                                }, showEndOfContent: false })))),
                React.createElement("div", { style: { width: "100%", height: "100%", paddingLeft: "20px", paddingRight: "20px", paddingBottom: "140px", paddingTop: "10px" } },
                    React.createElement(highcharts_react_official_1.default, { highcharts: highcharts_1.default, options: {
                            ...
                            xAxis: {
                                ...
                                labels: {
                                    style: {
                                        fontSize: 14,
                                        fontWeight: 'bold',
                                        color: isDarkMode ? '#ffffff' : '#ababab'
                                    }
                                }
                            },
                            yAxis: {
                                ...
                                allowDecimals: false,
                                gridLineColor: isDarkMode ? 'rgba(255, 255, 255, 0.1)' : '#595959',
                                labels: {
                                    style: {
                                        fontSize: 14,
                                        fontFamily: 'cambria',
                            ...
                            tooltip: {
                                ...
                                formatter: function () {
                                    console.log(this);
                                    return (`<div>
                                                        <table style="background-color:${this.color};padding:10px; border-radius:5px; position:relative;"><tbody>
                                                            <tr>
                                                                <td style="font-weight:bolder; font-size:13px; text-align:left;">
                                                                    ${selectedYear}-${this.x}
                                                                </td>
                                                            </tr>
                                                            <tr>
        ...
        React.createElement("div", { style: { height: "800px", marginBottom: "20px" } },
            React.createElement(SLAStackchartdemo_1.default, { uxpContext: props.uxpContext }))));
};
exports["default"] = DefectSummary;


/***/ }),

/***/ "./src/demo/SLACountInsidedemo.tsx":
/*!*****************************************!*\
  !*** ./src/demo/SLACountInsidedemo.tsx ***!
  \*****************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
const SLAStackchart = (props) => {
    const [BaseYear, setBaseYear] = React.useState(null);
    const [BaseYearData, setBaseYearData] = React.useState([]);
    const [SelectYearData, setSelectYearData] = React.useState([]);
    const [BaseTarget, setBaseTarget] = React.useState(null);
    const [SelecTarget, setSelecTarget] = React.useState(null);
    const [BaseMeanVal, setBaseMeanVal] = React.useState(null);
    const [SelectMeanVal, setSelectMeanVal] = React.useState(null);
    const [HighValue, setHighValue] = React.useState(null);
    const [SelectCount, setSelectCount] = React.useState(null);
    const [BaseCount, setBaseCount] = React.useState(null);
    React.useEffect(() => {
        if (props.LocationKey != null && props.PiorityKey != null && props.Year != null) {
            setBaseYear('2020');
            GetCountData('2020');
        }
    }, [props.LocationKey, props.PiorityKey, props.Year]);
    let toast = (0, components_1.useToast)();
    function GetCountData(baseyr) {
        return __awaiter(this, void 0, void 0, function* () {
            // props.uxpContext?.executeAction("C2ODashboard", 'GetSLACountData', {SelectYear:props.Year,BaseYear:baseyr,Locationkey:props.LocationKey,PriorityKey:props.PiorityKey}, { json: true })
            // .then(res => {
            //     console.log(res,"res.BaseYearData");
            //     SettingData(res.BaseYearData,res.SelectYearData);
            //     if(res.BaseYearTarget.length > 0){
            //         setBaseTarget(res.BaseYearTarget[0]['TargetTime']);
            //     }
            //     if(res.SelectYearTarget.length > 0){
            //         setSelecTarget(res.SelectYearTarget[0]['TargetTime']);
            //     }
            // })
            //     .catch(e => {
            //     console.log("except: ", e);
            ...
            try {
                let execurl = '';
                if (`${window.location.origin}/` === 'https://test.maftestbed.servicedeskhq.com/') {
                    execurl = 'https://script.google.com/macros/s/AKfycbxlbnRd9UJLiVEhFgovTyccXFpPey-W6sJphQpjjpeVoGgI8EzURpPN3MO2wZnNG2O1eg/exec';
                }
                else {
                    execurl = 'https://script.google.com/macros/s/AKfycbwAcneXvQlgwASLieDMZ3l0o1iwlJqqw2JPkb0YCQHPd8lKQ55Sbh_SSqiNm6ToSM6QvA/exec';
                }
                let property = `${execurl}?SelectYear=${props.Year}&BaseYear=${baseyr}&LocationKey=${props.LocationKey}&PriorityKey=${props.PiorityKey}`;
                let gotdailydetails = yield fetch(property);
                let res = yield gotdailydetails.json();
                SettingData(res.BaseYearData, res.SelectYearData);
                if (res.BaseYearTarget.length > 0) {
                    setBaseTarget(res.BaseYearTarget[0]['TargetTime']);
                }
    ...
    function SettingData(BaseDataArray, SelectDataArray) {
        return __awaiter(this, void 0, void 0, function* () {
            let basedata = yield OrganizeChartData(BaseDataArray, 'Base SLA');
            setBaseYearData(basedata.Datalist);
            setBaseMeanVal(basedata.MeanVal);
            setBaseCount(basedata.MeanCt);
            let slctyr = yield OrganizeChartData(SelectDataArray, 'Current SLA');
            setSelectYearData(slctyr.Datalist);
            setSelectMeanVal(slctyr.MeanVal);
            setSelectCount(slctyr.MeanCt);
            if (slctyr.MaxVal > basedata.MaxVal) {
                setHighValue(slctyr.MaxVal);
            }
            else {
                setHighValue(basedata.MaxVal);
            }
        });
    }
    function OrganizeChartData(DataArray, NameVal) {
        return __awaiter(this, void 0, void 0, function* () {
            let meanval = 0;
            let cnt = 0;
            let ct = 0;
            let maxval = 0;
            var ocd = yield DataArray.map((item, ik) => {
                if (parseFloat(item.Count) > 0) {
                    ct = ct + 1;
                }
                if (maxval < parseFloat(item.Count)) {
                    maxval = parseFloat(item.Count);
                }
                cnt = cnt + parseFloat(item.Count);
                meanval = meanval + (parseFloat(item.AvgMin) * parseFloat(item.Count));
                return ({
                    x: parseFloat(item.AvgMin),
                    y: parseFloat(item.Count),
                    name: NameVal
                });
            });
            return { Datalist: ocd, MeanVal: (meanval / (cnt > 0 ? cnt : 1)), MeanCt: (cnt / (ct > 0 ? ct : 1)), MaxVal: maxval };
        });
    }
    return (React.createElement("div", { id: "", className: "SLACount-WidgetContainer" },
        React.createElement(highcharts_react_official_1.default, { highcharts: highcharts_1.default, options: {
                title: {
                    text: '',
                    style: {
                ...
                legend: {
                    ...
                    x: -100,
                    floating: true,
                    backgroundColor: highcharts_1.default.defaultOptions.legend.backgroundColor || 'white',
                    borderColor: '#CCC',
                    borderWidth: 1,
                    shadow: false,
                    itemStyle: {
                ...
                tooltip: {
                    ...
                    pointFormatter: function () {
                        console.log(this);
                        let msg = `<div>
                                                <table><tbody><tr><td><div style="font-size:14px; font-weight:bolder; color:${this.color} ">( ${this.x > 0 ? this.x - 10 : 0} - ${this.x} ) mins</div></td></tr></tbody></table>
                                                <table><tbody><tr><td><div style="font-size:13px; font-weight:bold; color:${this.color} ">${this.name}         Count: ${this.y}</div></td></tr></tbody></table>
                                            </div>`;
                        if (this.x > 0) {
                            return msg;
                        }
                ...
                series: [
                    ...
                    },
                    {
                        ...
                        data: [{ x: parseFloat(BaseTarget), low: 0, high: (HighValue + (HighValue * 5 / 100)), color: '#ebba59' }],
                        type: 'columnrange',
                        pointWidth: 3,
                        borderWidth: 0,
                        grouping: true,
                        ...
                        dataLabels: {
                            ...
                            formatter: function () {
                                if (this.y != 0) {
                                    return `<div style="color:#ebba59; font-size:12px; font-weight:bold;">Base SLA</div>`;
                                }
                                else {
                                    return '';
                                }
                    ...
                    },
                    {
                        ...
                        linkedTo: ':previous',
                        enableMouseTracking: false,
                        data: [{ x: parseFloat(SelecTarget), low: 0, high: (HighValue + (HighValue * 5 / 100)), color: '#6fe36f' }],
                        type: 'columnrange',
                        pointWidth: 3,
                        borderWidth: 0,
                        grouping: true,
                        ...
                        dataLabels: {
                            ...
                            formatter: function () {
                                if (this.y != 0) {
                                    return `<div style="color:#6fe36f; font-size:12px; font-weight:bold;">Current SLA</div>`;
                                }
                                else {
                                    return '';
                                }
...
exports["default"] = SLAStackchart;


/***/ }),

/***/ "./src/demo/SLAStackchartdemo.tsx":
/*!****************************************!*\
  !*** ./src/demo/SLAStackchartdemo.tsx ***!
  \****************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
(0, highcharts_more_1.default)(highcharts_1.default);
(0, bullet_1.default)(highcharts_1.default);
const SLACountInsidedemo_1 = __importDefault(__webpack_require__(/*! ./SLACountInsidedemo */ "./src/demo/SLACountInsidedemo.tsx"));
const axios_1 = __importDefault(__webpack_require__(/*! axios */ "./node_modules/axios/dist/browser/axios.cjs"));
const base_url_content_1 = __webpack_require__(/*! ./base-url-content */ "./src/demo/base-url-content.tsx");
const Xcategories = [
    'JAN',
...
const SLAStackchart = (props) => {
    // const API_KEY = `${props.uxpContext?.apiKey}`;
    const API_KEY = `SC:c2o:006ec0e51ef083e0`;
    const [ResolveLoadData, setResolveLoadData] = React.useState(false);
    const [RespondLoadData, setRespondLoadData] = React.useState(false);
    ...
    React.useEffect(() => {
        ...
        setTimeout(() => {
            const element = document.getElementById('slastackchart-main');
            const width = (element === null || element === void 0 ? void 0 : element.clientWidth) || 1200;
            const height = (element === null || element === void 0 ? void 0 : element.clientHeight) || 600;
            setCHLength(width);
            setCHHeight(height);
        }, 500);
    }, []);
    React.useEffect(() => {
        setYear(YearList.length > 0 ? YearList[0].value : null);
    }, [YearList]);
    function GetLocations() {
        return __awaiter(this, void 0, void 0, function* () {
            // props.uxpContext?.executeAction("C2ODashboard", 'GetBuildings', {}, { json: true })
    ...
    React.useEffect(() => {
        setRespondLoadData(false);
        setResolveLoadData(false);
        setRespondChartDataset([]);
        setResolveChartDataset([]);
        if (LocationKey != null && LocationKey != '' && PiorityKey != null && PiorityKey != '' && Year != null && Year != '') {
            setTimeout(() => {
                GetSLAPriowiseStackData();
            }, 600);
        }
    }, [LocationKey, PiorityKey, Year]);
    // Additional effect to trigger data loading when dimensions are ready
    React.useEffect(() => {
        if (CHLength > 0 && CHHeight > 0 && LocationKey != null && LocationKey != '' && PiorityKey != null && PiorityKey != '' && Year != null && Year != '') {
            GetSLAPriowiseStackData();
        }
    }, [CHLength, CHHeight]);
    React.useEffect(() => {
    ...
    function ChoosePiority() {
        return __awaiter(this, void 0, void 0, function* () {
            var __FOUNDID = yield PiorityLevels.find(function (post, index) {
                if (post.value == PiorityKey) {
                    return post.label;
                }
            });
            if (__FOUNDID != undefined) {
                setPriorityID(__FOUNDID.label);
            }
        });
    }
    let toast = (0, components_1.useToast)();
    function GetSLAPriowiseStackData() {
        return __awaiter(this, void 0, void 0, function* () {
            const element = document.getElementById('slastackchart-main');
            const width = (element === null || element === void 0 ? void 0 : element.clientWidth) || 1200;
            const height = (element === null || element === void 0 ? void 0 : element.clientHeight) || 600;
            ...
            if (LocationKey != null && PiorityKey != null && Year != null) {
                let appurl = 'C2ODemo/C2ODemoOrphans';
                let execurl = `${base_url_content_1.BASE_URL}/api/${appurl}/GetC2ODemoSLAComplianceAPI`;
                let parm = `&LocationKey=${LocationKey}&PriorityKey=${PiorityKey}&Year=${Year}`;
                axios_1.default.get(`${execurl}?apikey=${API_KEY}${parm}`)
                    .then(response => {
                    let res = response.data;
                    OrganizeData(res);
    ...
    const [RespondChartDataset, setRespondChartDataset] = React.useState([]);
    const [ResolveChartDataset, setResolveChartDataset] = React.useState([]);
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (var t = 0; t < 12; t++) {
                ...
                if (__FOUNDBase != undefined) {
                    belowDataset_ad.push({ x: t, y: parseFloat(__FOUNDBase.RABAdherence), Count: parseFloat(__FOUNDBase.RABAdherenceCount), name: "SLA Adherence" });
                    aboveDataset_ad.push({ x: t, y: parseFloat(__FOUNDBase.RABBreach), Count: parseFloat(__FOUNDBase.RABBreachCount), name: "SLA Breach" });
                    belowDataset_br.push({ x: t, y: parseFloat(__FOUNDBase.REBAdherence), Count: parseFloat(__FOUNDBase.REBAdherenceCount), name: "SLA Adherence" });
                    aboveDataset_br.push({ x: t, y: parseFloat(__FOUNDBase.REBBreach), Count: parseFloat(__FOUNDBase.REBBreachCount), name: "SLA Breach" });
                }
            }
            setRespondChartDataset([
                {
                    name: 'SLA Adherence',
                    data: belowDataset_ad,
                    color: "#7ce065"
                }, {
                    name: 'SLA Breach',
                    data: aboveDataset_ad,
                    color: "#f2ae66"
                }
            ]);
            setRespondLoadData(true);
            setResolveChartDataset([
                {
                    name: 'SLA Adherence',
                    data: belowDataset_br,
                    color: "#7ce065"
                }, {
                    name: 'SLA Breach',
                    data: aboveDataset_br,
                    color: "#f2ae66"
                }
            ]);
            setResolveLoadData(true);
        });
    }
    return (React.createElement("div", { className: "dark-mode", style: {
            width: "100%",
            height: "100%",
        ...
        React.createElement("div", { style: {
            ...
            React.createElement("div", { id: "slastackchart-main", className: "SLAStackChart-WidgetContainer", style: { width: "100%" } },
                React.createElement("div", { style: {
                        backgroundColor: "transparent",
                        padding: "15px 20px",
                        color: "#ffffff",
                    ...
                    React.createElement("div", { style: {
                        ...
                        React.createElement("div", { style: {
                            ...
                            React.createElement("svg", { width: "20", height: "20", viewBox: "0 0 640 512", fill: "none", xmlns: "http://www.w3.org/2000/svg" },
                                React.createElement("path", { d: "M528 448H352V153.25c20.42-8.94 36.1-26.22 43.38-47.47l132-44.26c8.38-2.81 12.89-11.88 10.08-20.26l-10.17-30.34C524.48 2.54 515.41-1.97 507.03.84L389.11 40.37C375.3 16.36 349.69 0 320 0c-44.18 0-80 35.82-80 80 0 3.43.59 6.71 1.01 10.03l-128.39 43.05c-8.38 2.81-12.89 11.88-10.08 20.26l10.17 30.34c2.81 8.38 11.88 12.89 20.26 10.08l142.05-47.63c4.07 2.77 8.43 5.12 12.99 7.12V496c0 8.84 7.16 16 16 16h224c8.84 0 16-7.16 16-16v-32c-.01-8.84-7.17-16-16.01-16zm111.98-144c0-16.18 1.34-8.73-85.05-181.51-17.65-35.29-68.19-35.36-85.87 0-87.12 174.26-85.04 165.84-85.04 181.51H384c0 44.18 57.31 80 128 80s128-35.82 128-80h-.02zM440 288l72-144 72 144H440zm-269.07-37.51c-17.65-35.29-68.19-35.36-85.87 0C-2.06 424.75.02 416.33.02 432H0c0 44.18 57.31 80 128 80s128-35.82 128-80h-.02c0-16.18 1.34-8.73-85.05-181.51zM56 416l72-144 72 144H56z", fill: "#ffffff" }))),
                ...
                React.createElement("div", { style: { width: "100%", paddingLeft: "20px", paddingRight: "20px", position: 'relative' } },
                    React.createElement("div", { className: "SLA-ColumnDevide", style: { width: "100%", marginTop: "-20px", padding: "0px 20px" } },
                        React.createElement("div", { className: "SLA-Column", style: { width: "90%" } }),
                        React.createElement("div", { className: "SLA-Column", style: { width: "10%", paddingRight: "20px" } },
                            React.createElement("div", { style: { display: "flex", flexDirection: "row", alignItems: "center", width: "80px", height: "50px", cursor: 'pointer', float: "right", marginTop: "16px" }, onClick: () => { setOpenInside(true); } },
                                React.createElement("div", { style: { marginRight: "5px", marginLeft: "30px", marginTop: "3px" } },
                                    React.createElement("svg", { width: "16", height: "16", viewBox: "0 0 24 24", fill: "none", xmlns: "http://www.w3.org/2000/svg" },
                                        React.createElement("circle", { cx: "12", cy: "12", r: "10", stroke: "#ffffff", strokeWidth: "2" }),
                                        React.createElement("path", { d: "M12 16v-4", stroke: "#ffffff", strokeWidth: "2", strokeLinecap: "round" }),
                                        React.createElement("path", { d: "M12 8h.01", stroke: "#ffffff", strokeWidth: "2", strokeLinecap: "round" }))),
                                React.createElement("div", { style: { fontWeight: 'bold', fontSize: '13px', color: '#ffffff' } }, "Insight"))))),
                React.createElement("div", { style: { width: "100%", display: "flex", flexDirection: "column" } },
                    React.createElement("div", { style: { width: "100%", padding: '10px 5px 5px 10px' } },
                        React.createElement("div", { className: 'stckslachart-selectivebox' },
                            React.createElement("div", { style: { width: "100%", paddingLeft: "40px", fontSize: "16px", fontWeight: "bolder", color: "#ffffff" } }, "SLA Respond"),
                            React.createElement("div", { style: { width: "100%", paddingLeft: "0px", paddingRight: "0px" } },
                                !RespondLoadData && React.createElement(components_1.Loading, null),
                                RespondLoadData &&
                                    React.createElement(highcharts_react_official_1.default, { highcharts: highcharts_1.default, options: {
                                            title: {
                                                text: '',
                                            ...
                                            tooltip: {
                                                ...
                                                useHTML: true,
                                                formatter: function () {
                                                    let msg = `<div><table><tbody><tr><td><div style="font-weight:bolder;">${this.x}</div></td></tr></tbody></table>
                                                            <table><tbody><tr><td><div style="width:15px; height:15px; background-color:${this.color};"></div></td><td><div style="font-weight:bolder;">${this.point.name}</div></td></tr></tbody></table>
                                                            <table><tbody><tr><td><div>Precentage : </div></td><td><div>${(Math.round(this.y * 100) / 100).toString()}%</div></td></tr></tbody></table>
                                                            <table><tbody><tr><td><div>Count : </div></td><td><div>${this.point.Count}</div></td></tr></tbody></table>
                                                            </div>`;
                                                    return msg;
                                                }
                                            },
                    ...
                    React.createElement("div", { style: { width: "100%", padding: '10px 5px 5px 10px' } },
                        React.createElement("div", { className: 'stckslachart-selectivebox' },
                            React.createElement("div", { style: { width: "100%", paddingLeft: "40px", fontSize: "16px", fontWeight: "bolder", color: "#ffffff" } }, "SLA Resolve"),
                            React.createElement("div", { style: { width: "100%", paddingLeft: "0px", paddingRight: "0px" } },
                                !ResolveLoadData && React.createElement(components_1.Loading, null),
                                ResolveLoadData &&
                                    React.createElement(highcharts_react_official_1.default, { highcharts: highcharts_1.default, options: {
                                            title: {
                                                text: '',
            ...
            React.createElement(components_1.LinkWidgetContainer, { show: OpenInside, className: "InsightPopup-DarkTheam", onOpen: () => { }, onClose: () => setOpenInside(false), title: React.createElement("div", { style: { fontSize: "14px", fontWeight: 'bolder', color: 'white' } }, PriorityID) },
                React.createElement("div", { style: { position: "relative", paddingLeft: "20px", paddingRight: "20px" } },
                    React.createElement(SLACountInsidedemo_1.default, { LocationKey: LocationKey, PiorityKey: PiorityKey, Year: Year, uxpContext: props.uxpContext }))))));
};
exports["default"] = SLAStackchart;
...
const DefectSummaryPriorityWisedemo_1 = __importDefault(__webpack_require__(/*! ./demo/DefectSummaryPriorityWisedemo */ "./src/demo/DefectSummaryPriorityWisedemo.tsx"));
__webpack_require__(/*! ./styles.scss */ "./src/styles.scss");
(0, uxp_1.registerWidget)({
    id: "defectsummary-prioritywise-demo",
    widget: DefectSummaryPriorityWisedemo_1.default,
    configs: {
        layout: {
        // w: 12,
        // h: 12,
